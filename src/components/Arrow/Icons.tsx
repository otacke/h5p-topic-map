...
export const createEditIcon = (iconColor: string): JSX.Element => {
  return (
    <svg
      width="12"
      height="12"
...
export const createNoteIcon = (iconColor: string): JSX.Element => {
  return (
    <svg
      width="12"
      height="12"
...
export const createCompletedIcon = (iconColor: string): JSX.Element => {
  return (
    <svg
      width="12"
      height="12"
