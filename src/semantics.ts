...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        default:
          "<b>Progresjonsmåleren</b> viser hvor mange prosent av hendelsene og sammenhengene som har fått notater. 100% betyr at du har lagt inn notater på alle tilgjengelige stader.<br /><b>Eksporter notater</b> gir deg en oversikt over alle notatene du har skrevet. Der kan du skrive ut eller kopiere notatene for å f.eks. å lime dem inn i et dokument eller en e-post.<br /><b>Slett alle notater</b> sletter alle notatene fra nettleseren på datamaskinen du bruker.",
        type: H5PFieldType.Text,
      },
    ],
  },
